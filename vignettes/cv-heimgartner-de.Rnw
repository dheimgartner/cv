    ...
    \begin{cv}{\spacedallcaps{Curriculum Vit\ae}}
        ...
        \vspace{-3em}
            \begin{itemize}[nosep]
              ...
              \item Bug reporting (z.B. \url{https://github.com/r-lib/testthat/issues/1997})
              \item Teilnehmer an der useR 2024 Konferenz in Salzburg
              \end{itemize}
        ...
        \begin{cvlist}{\spacedlowsmallcaps{Fähigkeiten}}\label{skill}
            \item \textbf{Software:} \proglang{R}, Python, \LaTeX, git, bash, etwas C (primär durch Lektüre der Bibel \emph{The C Programming Language}) und JavaScript
