...
\thispagestyle{empty}
    \begin{cv}{\spacedallcaps{Curriculum Vit\ae}}
        ...
        \begin{cvlist}{\spacedlowsmallcaps{Über mich}}\label{irgendwas}
            \item  Ausgeprägte Lernbegeisterung und -fähigkeit; Fundierte Programmierkenntnisse und Verständnis für Softwarearchitektur, -konzepte; Quantitatives Modellieren (mathematische/statistische Kenntnisse, um neue Modelle schnell zu verstehen und anzuwenden); Ökonomische Perspektive; Interesse für Finanzsysteme; Sichere wissenschaftliche und professionelle Ausdrucksweise in Wort und Schrift; Präsentationskompetenz; Gewisser Sinn für (Prozess-) Ästhetik; Integre und selbstmotivierte Person
        \end{cvlist}
        ...
        \begin{cvlist}{\spacedlowsmallcaps{Ausbildung}}\label{education}
            ...
            \begin{itemize}
                \item \emph{The Impact of Telework on Transport Demand --- Data, Tools and Analysis}: Datenerhebung, Stated-Preference Umfragen, Wahlmodellierung, Kausale Inferenz, (Mit-) Entwicklung verschiedener \proglang{R}-Pakete (\pkg{OPSR}, \pkg{OPSRtools}, \pkg{mixl}, ...), \url{https://CRAN.R-project.org/package=OPSR}
                \item Projetkleiter \emph{Multimodality in the Swiss New Normal}: Projektpartner: SBB, AMAG, Tiefbauamt Zürich, Kanton Zürich; Organisation und Leitung der Begleitgruppensitzungen sowie der Forschungsgruppe
                \item Datenverantwortlicher: Pflege der Forschungsdatensätze und verschiedener Datenbanken, Ansprechsperson für Datenzugang, Austausch mit diversen internen und externen Stakeholders
            ...
            \end{itemize}
            \item \textbf{Militärdienst als Gebirgspezialist}, Kompetenzzentrum Gebirgsdienst der Armee, Adermatt
            \marginpar{2012--2013}
            \begin{itemize}
        ...
        \begin{cvlist}{\spacedlowsmallcaps{Berufserfahrung}}\label{work}
            ...
            \marginpar{2020}
            \begin{itemize}
                \item Integriert im Team Data Science
            ...
            \marginpar{2019}
            \item \textbf{Diverse Studentenjobs:} Tankstellenshop BP Wohlen (jeden Dienstag Abend und an Wochenenden während dem Gymnasium); Bergartikelverkäufer Bächli Bergsport, ...
        \end{cvlist}
